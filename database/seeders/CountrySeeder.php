    ...
    public function run(): void
    {
        DB::table('countries')->insert(
            [
                ...
                ['country_code' => 'BL', 'country' => 'Saint Bartholemy'],
                ['country_code' => 'BM', 'country' => 'Bermuda'],
                ['country_code' => 'BN', 'country' => 'Brunei Darussalam'],
                ['country_code' => 'BO', 'country' => 'Bolivia, Plurinational State of'],
                ...
                ['country_code' => 'CC', 'country' => 'Cocos Keeling  Islands'],
                ['country_code' => 'CD', 'country' => 'Congo, the Democratic Republic of the'],
                ['country_code' => 'CF', 'country' => 'Central African Republic'],
                ['country_code' => 'CG', 'country' => 'Congo'],
                ['country_code' => 'CH', 'country' => 'Switzerland'],
                ['country_code' => 'CI', 'country' => 'Cote d\'Ivoire'],
                ...
                ['country_code' => 'FK', 'country' => 'Falkland Islands Malvinas '],
                ['country_code' => 'FM', 'country' => 'Micronesia, Federated States of'],
                ...
                ['country_code' => 'GS', 'country' => 'South Georgia and the South Sandwich Islands'],
                ...
                ['country_code' => 'HM', 'country' => 'Heard Island and McDonald Islands'],
                ...
                ['country_code' => 'IO', 'country' => 'British Indian Ocean Territory'],
                ['country_code' => 'IQ', 'country' => 'Iraq'],
                ['country_code' => 'IR', 'country' => 'Iran, Islamic Republic of'],
                ...
                ['country_code' => 'KP', 'country' => 'Korea, Democratic People\'s Republic of'],
                ...
                ['country_code' => 'LA', 'country' => 'Lao People\'s Democratic Republic'],
                ...
                ['country_code' => 'MD', 'country' => 'Moldova, Republic of'],
                ['country_code' => 'ME', 'country' => 'Montenegro'],
                ['country_code' => 'MF', 'country' => 'Saint Martin French part '],
                ['country_code' => 'MG', 'country' => 'Madagascar'],
                ['country_code' => 'MH', 'country' => 'Marshall Islands'],
                ['country_code' => 'MK', 'country' => 'Macedonia, the Former Yugoslav Republic of'],
                ...
                ['country_code' => 'RU', 'country' => 'Russian Federation'],
                ...
                ['country_code' => 'SH', 'country' => 'Saint Helena, Ascension and Tristan da Cunha'],
                ['country_code' => 'SI', 'country' => 'Slovenia'],
                ['country_code' => 'SJ', 'country' => 'Svalbard and Jan Mayen'],
                ...
                ['country_code' => 'SS', 'country' => 'South Sudan'],
                ['country_code' => 'ST', 'country' => 'Sao Tome and Principe'],
                ['country_code' => 'SV', 'country' => 'El Salvador'],
                ['country_code' => 'SX', 'country' => 'Sint Maarten Dutch part '],
                ['country_code' => 'SY', 'country' => 'Syrian Arab Republic'],
                ['country_code' => 'SZ', 'country' => 'Swaziland'],
                ['country_code' => 'TC', 'country' => 'Turks and Caicos Islands'],
                ['country_code' => 'TD', 'country' => 'Chad'],
                ['country_code' => 'TF', 'country' => 'French Southern Territories'],
                ...
                ['country_code' => 'TL', 'country' => 'Timor-Leste'],
                ...
                ['country_code' => 'TT', 'country' => 'Trinidad and Tobago'],
                ['country_code' => 'TV', 'country' => 'Tuvalu'],
                ['country_code' => 'TW', 'country' => 'Taiwan, Province of China'],
                ['country_code' => 'TZ', 'country' => 'Tanzania, United Republic of'],
                ['country_code' => 'UA', 'country' => 'Ukraine'],
                ['country_code' => 'UG', 'country' => 'Uganda'],
                ['country_code' => 'UM', 'country' => 'United States Minor Outlying Islands'],
                ['country_code' => 'US', 'country' => 'United States'],
                ['country_code' => 'UY', 'country' => 'Uruguay'],
                ['country_code' => 'UZ', 'country' => 'Uzbekistan'],
                ['country_code' => 'VA', 'country' => 'Holy See Vatican City State '],
                ['country_code' => 'VC', 'country' => 'Saint Vincent and the Grenadines'],
                ['country_code' => 'VE', 'country' => 'Venezuela, Bolivarian Republic of'],
                ['country_code' => 'VG', 'country' => 'Virgin Islands, British'],
                ['country_code' => 'VI', 'country' => 'Virgin Islands, U.S.'],
                ['country_code' => 'VN', 'country' => 'Viet Nam'],
